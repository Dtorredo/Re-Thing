(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/287ab_onnxruntime-web_dist_9e2edbbc._.js", {

"[project]/node_modules/.pnpm/onnxruntime-web@1.21.0-dev.20250206-d981b153d3/node_modules/onnxruntime-web/dist/ort.webgpu.bundle.min.mjs (static in ecmascript)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.v("/_next/static/media/ort.webgpu.bundle.min.e3c9a248.mjs");}}),
"[project]/node_modules/.pnpm/onnxruntime-web@1.21.0-dev.20250206-d981b153d3/node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.jsep.wasm (static in ecmascript)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.v("/_next/static/media/ort-wasm-simd-threaded.jsep.8853298b.wasm");}}),
"[project]/node_modules/.pnpm/onnxruntime-web@1.21.0-dev.20250206-d981b153d3/node_modules/onnxruntime-web/dist/ort.webgpu.bundle.min.mjs [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__import$2e$meta__ = {
    get url () {
        return `file://${__turbopack_context__.P("node_modules/.pnpm/onnxruntime-web@1.21.0-dev.20250206-d981b153d3/node_modules/onnxruntime-web/dist/ort.webgpu.bundle.min.mjs")}`;
    }
};
...
var Un = ((e1)=>("TURBOPACK compile-time value", "function") < "u" ? ("TURBOPACK member replacement", __turbopack_context__.z) : typeof Proxy < "u" ? new Proxy(e1, {
...
var Ht = (e1, t)=>{
    ...
    if (t && typeof t == "object" || typeof t == "function") for (let o of Wp(t))!Lp.call(e1, o) && o !== r && Rn(e1, o, {
        get: ()=>t[o],
        enumerable: !(n = Vp(t, o)) || n.enumerable
    });
    return e1;
};
var gr = (e1)=>Gp(Rn({}, "__esModule", {
        value: !0
    }), e1);
var br, St, Tt, Hp, Xi, Nn = U(()=>{
    "use strict";
    br = new Map, St = [], Tt = (e1, t, r)=>{
        if (t && typeof t.init == "function" && typeof t.createInferenceSessionHandler == "function") {
            let n = br.get(e1);
            if (n === void 0) br.set(e1, {
                backend: t,
                priority: r
            });
            else {
        ...
        let t = e1.executionProviders || [], r = t.map((l)=>typeof l == "string" ? l : l.name), n = r.length === 0 ? St : r, o, i = [], a = new Set;
        for (let l of n){
            let p = await Hp(l);
...
var Wn, sa, ua, da, la, ca, pa = U(()=>{
    ...
    Wn = (e1, t)=>{
        ...
        if (r) {
            ...
            if (u != null) {
                let h = e1.height, _ = e1.width;
                return u.drawImage(e1, 0, 0, _, h), a = u.getImageData(0, 0, _, h).data, d.height = h, d.width = _, Wn(a, d);
            } else throw new Error("Can not access image data");
        } else {
...
var It, Ft, ma, fa, ha = U(()=>{
    ...
    It = new Map([
        ...
        if (!ma) {
            ...
            e1 && (It.set("int64", BigInt64Array), Ft.set(BigInt64Array, "int64")), t && (It.set("uint64", BigUint64Array), Ft.set(BigUint64Array, "uint64")), r ? (It.set("float16", Float16Array), Ft.set(Float16Array, "float16")) : It.set("float16", Uint16Array);
        }
    };
});
var ga, ba, ya = U(()=>{
...
var _r, _a, Ne, Be, Gn = U(()=>{
    ...
    _r = (e1, t)=>{
        ...
        (typeof Ue.trace > "u" ? !Ue.wasm.trace : !Ue.trace) || _a("BEGIN", e1);
    }, Be = (e1)=>{
        (typeof Ue.trace > "u" ? !Ue.wasm.trace : !Ue.trace) || _a("END", e1);
    };
});
var wr, wa = U(()=>{
    "use strict";
            ...
            if (typeof r == "object") {
                ...
                if (Array.isArray(r)) {
                    ...
                    for (let u of this.outputNames)if (m.indexOf(u) !== -1) {
                        let h = r[u];
                        (h === null || h instanceof Fe) && (p = !0, a = !1, o[u] = h);
                    }
                    if (p) {
                        if (typeof n == "object" && n !== null) i = n;
                        else if (typeof n < "u") throw new TypeError("'options' must be an object.");
...
var Ca, Aa, qp, Ea = U(()=>{
    ...
    qp = Aa ? null : (e1)=>new Worker(e1 ?? Ve, {
            type: "module",
            name: Ca
        });
});
...
var qn, Pa, Kp, Oa = U(()=>{
    "use strict";
    Pa = (qn = __TURBOPACK__import$2e$meta__.url, async function(e1 = {}) {
        function t() {
...
`));
            ...
            let s = function(c) {
                try {
                    ...
                    if (b === "load") {
                        ...
                        On(f.pthread_ptr, 0, 0, 1, 0, 0), Cn(f.pthread_ptr), xc(), Go(), V || (Vi(), V = !0);
                        try {
        ...
        var K, we, j, Q, ie, te, be, Oe, ve, de, W, Y, he, De = !1;
        function pe() {
            var s = K.buffer;
        ...
        if (!g) {
            if (!((K = new WebAssembly.Memory({
                initial: 256,
                maximum: 65536,
                shared: !0
            })).buffer instanceof x)) throw L("requested a shared WebAssembly.Memory but the returned buffer is not a SharedArrayBuffer, indicating that while the browser has SharedArrayBuffer it does not have WebAssembly threads support - you may need to set a flag"), Error("bad memory");
            pe();
        }
        ...
        function ct(s) {
            throw L(s = "Aborted(" + s + ")"), De = !0, j = 1, s = new WebAssembly.RuntimeError(s + ". Build with -sASSERTIONS for more info."), m(s), s;
        }
        ...
        function Ro(s, c, f) {
            return (function(b) {
                if (!P && (_ || y)) {
                    if (typeof fetch == "function" && !Bo(b)) return fetch(b, {
        ...
        var gn = {
            ...
            917993: ()=>typeof wasmOffsetConverter < "u",
            918050: (s)=>{
                u.kb("Abs", s, void 0);
            },
            918101: (s)=>{
            ...
            922538: (s, c, f, b, w, I, O, B, G, F, X, le, ge, z, ue)=>{
                u.kb("ConvTranspose", s, {
                    ...
                    wIsConst: ()=>!!t()[F >>> 0],
                    outputPadding: X ? Array.from(i().subarray(Number(X) >>> 0, Number(le) >>> 0)) : [],
            ...
            922971: (s, c, f, b, w, I, O, B, G, F, X, le, ge, z)=>{
                u.kb("ConvTranspose", s, {
                    ...
                    wIsConst: ()=>!!t()[G >>> 0],
                    outputPadding: F ? Array.from(i().subarray(Number(F) >>> 0, Number(X) >>> 0)) : [],
                    outputShape: le ? Array.from(i().subarray(Number(le) >>> 0, Number(ge) >>> 0)) : [],
                    activation: Ce(z)
                });
            },
            ...
            924817: (s, c, f, b, w, I, O, B, G, F, X, le, ge, z)=>{
                u.kb("AveragePool", s, {
                    ...
                    kernel_shape: B ? Array.from(i().subarray(Number(B) >>> 0, Number(G) >>> 0)) : [],
                    pads: F ? Array.from(i().subarray(Number(F) >>> 0, Number(X) >>> 0)) : [],
                    strides: le ? Array.from(i().subarray(Number(le) >>> 0, Number(ge) >>> 0)) : []
                });
            },
            925296: (s, c)=>{
                u.kb("GlobalAveragePool", s, {
            ...
            930418: (s, c, f, b, w, I, O, B, G, F, X, le, ge, z, ue, Se)=>{
                u.kb("Conv", s, {
                    ...
                    pads: B ? Array.from(i().subarray(Number(B) >>> 0, Number(G) >>> 0)) : [],
                    strides: F ? Array.from(i().subarray(Number(F) >>> 0, Number(X) >>> 0)) : [],
                    w_is_const: ()=>!!t()[Number(ge) >>> 0],
                    activation: Ce(z),
                    activation_params: ue ? Array.from(d().subarray(Number(ue) >>> 0, Number(Se) >>> 0)) : []
                });
            },
            931002: (s)=>{
                u.kb("Gelu", s, void 0);
        ...
        var Ho = (s)=>new Promise((c)=>{
                s.onmessage = (w)=>{
                    ...
                    } else I === "checkMailbox" ? or() : I === "spawnThread" ? No(w) : I === "cleanupThread" ? Lo(Ze[w.thread]) : I === "killThread" ? (w = w.thread, I = Ze[w], delete Ze[w], yn(I), Dn(w), $t.splice($t.indexOf(I), 1), I.Bb = 0) : I === "cancelThread" ? Ze[w.thread].postMessage({
                        cmd: "cancel"
                    }) : I === "loaded" ? (s.loaded = !0, c(s)) : I === "alert" ? alert(`Thread ${w.threadId}: ${w.text}`) : w.target === "setimmediate" ? s.postMessage(w) : I === "callHandler" ? u[w.handler](...w.args) : I && L(`worker sent an unknown command ${I}`);
                }, s.onerror = (w)=>{
        ...
        function Fo() {
            var s = new Worker(__TURBOPACK__import$2e$meta__.url.startsWith("file:") ? new __turbopack_context__.U(__turbopack_context__.r("[project]/node_modules/.pnpm/onnxruntime-web@1.21.0-dev.20250206-d981b153d3/node_modules/onnxruntime-web/dist/ort.webgpu.bundle.min.mjs (static in ecmascript)")) : new URL(__TURBOPACK__import$2e$meta__.url), {
                type: "module",
        ...
        function Ko(s, c, f, b) {
            ...
            var w = [];
            return g && w.length === 0 ? qo(s, c, f, b) : (s = {
                ic: f,
                Bb: s,
                Rb: b,
                nc: w
            }, g ? (s.Nb = "spawnThread", postMessage(s, w), 0) : No(s));
        }
        ...
        function kc(s, c, f) {
            f >>>= 0, st(s >>>= 0, {
                ...
                argPackAdvance: ft,
                readValueFromPointer: ci(c, f, c.indexOf("u") == -1),
                Eb: null
            });
        }
        var ft = 8;
        ...
        function Bc(s, c, f, b, w) {
            ...
            st(s, {
                ...
                toWireType: O,
                argPackAdvance: ft,
                readValueFromPointer: ci(c, f, b !== 0),
                Eb: null
            });
        }
        function Mc(s, c, f) {
        ...
        function jc(s, c) {
            (s >>>= 0) == c >>> 0 ? setTimeout(or) : g ? postMessage({
                targetThread: s,
                cmd: "checkMailbox"
            ...
            return function(c) {
                if (!De) {
                    if (ht === 0) {
                        ...
                        c((w = 0)=>{
                            if (!De && (hi = w, f = !0, b)) {
                                ht = 2, ar(()=>ji(Xe)), typeof Browser < "u" && Browser.Lb.Sb && Browser.Lb.resume(), w = !1;
                                try {
                                    var I = function() {
                                        var G = i()[Xe + 8 >>> 2 >>> 0];
                                ...
                                if (!Xe) {
                                    var B = kn;
                                    B && (kn = null, (w ? B.reject : B.resolve)(I), O = !0);
                                }
                                if (w && !O) throw I;
                            }
        ...
        var sp = (s)=>{
            ...
            return f;
        }, wi = (s, c)=>Object.defineProperty(c, "name", {
                value: s
            });
        function dp(s, c, f) {
...
`, I = 0, O = [];
            ...
            for(var B = [
                ...
                b
            ], F = 0; F < s; ++F)O.push("arg" + F), B.push("argType" + F), G.push(c[F]), w += `  var arg${F} = argType${F}.readValueFromPointer(args${I ? "+" + I : ""});
...
`), s = (function(X) {
        ...
        var Bt = (s)=>s % 4 == 0 && (s % 100 != 0 || s % 400 == 0), vi = [
            0,
            31,
            60,
            91,
        ...
        function xp(s, c, f, b) {
            ...
            a()[s >>> 2 >>> 0] = 60 * G, i()[c >>> 2 >>> 0] = +(w != B), I = (s = (F)=>F.toLocaleTimeString(void 0, {
                    hour12: !1,
                    timeZoneName: "short"
                }).split(" ")[1])(I), O = s(O), B < w ? (Dt(I, f, 17), Dt(O, b, 17)) : (Dt(I, b, 17), Dt(O, f, 17));
        }
        var En = [], Ti = (s, c)=>{
            En.length = 0;
            for(var f; f = r()[s++ >>> 0];){
...
`))[0] == "Error" && b.shift(), Ci(b);
        ...
        function Ri(s, c, f, b) {
            ...
            for(var X in b = {
                ...
                "%OW": "%W",
                "%Oy": "%y"
            })f = f.replace(new RegExp(X, "g"), F[X]);
...
`,
                ...
                "%Z": (z)=>z.mc,
                "%%": ()=>"%"
            }, f = f.replace(/%%/g, "\0\0"), F)f.includes(X) && (f = f.replace(new RegExp(X, "g"), F[X](b)));
            return X = function(z) {
                var ue = Array(vn(z) + 1);
        ...
        }, ut.push(0, 1, void 0, 1, null, 1, !0, 1, !1, 1), u.count_emval_handles = ()=>ut.length / 2 - 5 - Sn.length;
        var Np = [
            _n,
            Vo,
            qo,
            ...
            return hn ||= u.locateFile ? Do("ort-wasm-simd-threaded.jsep.wasm") ? "ort-wasm-simd-threaded.jsep.wasm" : u.locateFile ? u.locateFile("ort-wasm-simd-threaded.jsep.wasm", C) : C + "ort-wasm-simd-threaded.jsep.wasm" : new __turbopack_context__.U(__turbopack_context__.r("[project]/node_modules/.pnpm/onnxruntime-web@1.21.0-dev.20250206-d981b153d3/node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.jsep.wasm (static in ecmascript)")).href, (function(f, b) {
                var w = hn;
                return P || typeof WebAssembly.instantiateStreaming != "function" || Do(w) || Bo(w) || typeof fetch != "function" ? Ro(w, f, b) : fetch(w, {
                    credentials: "same-origin"
        ...
        function Zi() {
            0 < wt || (g ? (p(u), g || nr(He), startWorker(u)) : (nr(Ie), 0 < wt || pr || (pr = !0, u.calledRun = !0, De || (g || nr(He), p(u), g || nr(mn)))));
        }
...
var Ma, jp, Ve, Ra, Kn, Yp, Zp, Ua, Qp, Da, Na, Ba, Va, $r = U(()=>{
    "use strict";
    vr();
    Ma = !1 || typeof location > "u" ? void 0 : location.origin, jp = ()=>{
        if ("TURBOPACK compile-time truthy", 1) return __TURBOPACK__import$2e$meta__.url?.startsWith("file:") ? new URL(new __turbopack_context__.U(__turbopack_context__.r("[project]/node_modules/.pnpm/onnxruntime-web@1.21.0-dev.20250206-d981b153d3/node_modules/onnxruntime-web/dist/ort.webgpu.bundle.min.mjs (static in ecmascript)")).href, Ma).href : __TURBOPACK__import$2e$meta__.url;
    }, Ve = jp(), Ra = ()=>{
        if (Ve && !Ve.startsWith("blob:")) return Ve.substring(0, Ve.lastIndexOf("/") + 1);
    }, Kn = (e1, t)=>{
        try {
            let r = t ?? Ve;
            return (r ? new URL(e1, r) : new URL(e1)).origin === Ma;
        } catch  {
            return !1;
        }
    }, Yp = (e1, t)=>{
    ...
    }, Zp = (e1, t)=>`${t ?? "./"}${e1}`, Ua = async (e1)=>{
        let r = await (await fetch(e1, {
            credentials: "same-origin"
        })).blob();
        return URL.createObjectURL(r);
    }, Qp = async (e1)=>(await import(/*webpackIgnore:true*/ e1)).default, Da = (Ea(), gr(ka)).default, Na = async ()=>{
    ...
    }, Ba = (Oa(), gr(za)).default, Va = async (e1, t, r)=>{
        if (!e1 && !t && Ba && Ve && Kn(Ve)) return [
            void 0,
            Ba
        ];
        {
            let n = "ort-wasm-simd-threaded.jsep.mjs", o = e1 ?? Yp(n, t), i = !!1 && r && o && !Kn(o, t), a = i ? await Ua(o) : o ?? Zp(n, t);
            return [
                i ? a : void 0,
                await Qp(a)
            ];
...
var jn, Yn, Pr, Wa, Xp, Jp, xr, Te, gt = U(()=>{
    ...
    Yn = !1, Pr = !1, Wa = !1, Xp = ()=>{
        ...
        let o = e1.wasmPaths, i = typeof o == "string" ? o : void 0, a = o?.mjs, d = a?.href ?? a, l = o?.wasm, p = l?.href ?? l, m = e1.wasmBinary, [u, h] = await Va(d, i, r > 1), _ = !1, y = [];
        if (t > 0 && y.push(new Promise((g)=>{
            ...
            h($).then((v)=>{
                Pr = !1, Yn = !0, jn = v, g(), u && URL.revokeObjectURL(u);
            }, (v)=>{
                Pr = !1, Wa = !0, x(v);
            });
...
var ke, Kt, ce, zr = U(()=>{
    ...
    gt();
    ke = (e1, t)=>{
        let r = Te(), n = r.lengthBytesUTF8(e1) + 1, o = r._malloc(n);
...
var La, Ga = U(()=>{
    ...
    La = (e1)=>{
        ...
        try {
            ...
            let i = 0;
            return e1?.tag !== void 0 && (i = ke(e1.tag, n)), r = t._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, i), r === 0 && ce("Can't create run options."), e1?.extra !== void 0 && Kt(e1.extra, "", new WeakSet, (a, d)=>{
...
var em, tm, rm, nm, Ha, Fa = U(()=>{
    ...
    em = (e1)=>{
        ...
        for (let n of t){
                ...
                case "webnn":
                    if (o = "WEBNN", typeof n != "string") {
                        ...
                        if (d) {
                            ...
                            Te()._OrtAddSessionConfigEntry(e1, l, p) !== 0 && ce(`Can't set a session config entry: 'deviceType' - ${d}.`);
                        }
                    }
                    break;
                case "webgpu":
                    if (o = "JS", typeof n != "string") {
                        ...
                        if (a?.preferredLayout) {
                            ...
                            Te()._OrtAddSessionConfigEntry(e1, d, l) !== 0 && ce(`Can't set a session config entry: 'preferredLayout' - ${a.preferredLayout}.`);
                        }
                    }
                    break;
                case "wasm":
            ...
            let i = ke(o, r);
            Te()._OrtAppendExecutionProvider(e1, i) !== 0 && ce(`Can't append execution provider: ${o}.`);
        }
    }, Ha = (e1)=>{
        let t = Te(), r = 0, n = [], o = e1 || {};
        rm(o);
        try {
            ...
            return o.extra !== void 0 && Kt(o.extra, "", new WeakSet, (u, h)=>{
...
var jt, bt, At, Or, Yt, Dr, Br, Zn, J = U(()=>{
    ...
    }, Dr = (e1)=>e1 === "float32" || e1 === "float16" || e1 === "int32" || e1 === "int64" || e1 === "uint32" || e1 === "uint8" || e1 === "bool" || e1 === "uint4" || e1 === "int4", Br = (e1)=>e1 === "float32" || e1 === "float16" || e1 === "int32" || e1 === "int64" || e1 === "uint32" || e1 === "uint64" || e1 === "int8" || e1 === "uint8" || e1 === "bool" || e1 === "uint4" || e1 === "int4", Zn = (e1)=>{
        switch(e1){
            case "none":
                return 0;
            case "cpu":
...
var ja, Jn, eo, sm, um, Ya, ro, to, Qa, Xa = U(()=>{
    ...
    ja = new Map([
    ...
    ]), Jn = [], eo = (e1)=>Math.ceil(Number(e1) / 16) * 16, sm = (e1)=>{
        for(let t = 0; t < Jn.length; t++){
            let r = Jn[t];
            if (e1 <= r) return r;
        }
        return Math.ceil(e1 / 16) * 16;
    }, um = 1, Ya = ()=>um++, ro = async (e1, t, r, n)=>{
        ...
        upload(t, r) {
            ...
            m.copyBufferToBuffer(l, 0, d.gpuData.buffer, 0, a), this.backend.device.queue.submit([
                m.finish()
            ]), l.destroy(), se("verbose", ()=>`[WebGPU] GpuDataManager.upload(id=${t})`);
        }
        memcpy(t, r) {
        ...
        create(t, r = GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_SRC | GPUBufferUsage.COPY_DST) {
            ...
            }), se("verbose", ()=>`[WebGPU] GpuDataManager.create(size=${t}) => id=${d.id}`), d;
        }
        get(t) {
...
var Et, ao, ye, Ee, N, me, so, Pt, qe, q, Vr, E, M, ts, Wr, io, rs, ae = U(()=>{
    ...
    }, me = (e1)=>e1 % 4 === 0 ? 4 : e1 % 2 === 0 ? 2 : 1, so = (e1 = "f32", t, r = "0")=>!t || t === 1 ? `${e1}(${r})` : `vec${t}<${e1}>(${r})`, Pt = (e1, t, r)=>e1 === "f32" ? r : t === 1 ? `f32(${r})` : `vec${t}<f32>(${r})`, qe = (e1, t)=>t === 4 ? `(${e1}.x + ${e1}.y + ${e1}.z + ${e1}.w)` : t === 2 ? `(${e1}.x + ${e1}.y)` : t === 3 ? `(${e1}.x + ${e1}.y + ${e1}.z)` : e1, q = (e1, t, r, n)=>e1.startsWith("uniforms.") && r > 4 ? typeof t == "string" ? n === "f16" ? `${e1}[(${t}) / 8][(${t}) % 8 / 4][(${t}) % 8 % 4]` : `${e1}[(${t}) / 4][(${t}) % 4]` : n === "f16" ? `${e1}[${Math.floor(t / 8)}][${Math.floor(t % 8 / 4)}][${t % 8 % 4}]` : `${e1}[${Math.floor(t / 4)}][${t % 4}]` : r > 1 ? `${e1}[${t}]` : e1, Vr = (e1, t, r, n, o)=>{
        let i = typeof r == "number", a = i ? r : r.length, d = [
            ...new Array(a).keys()
        ], l = a < 2 ? "u32" : a <= 4 ? `vec${a}<u32>` : `array<u32, ${a}>`, p = ao(t, o), m = typeof p == "string" ? p : p[1], u = typeof p == "string" ? p : p[0], h = {
            indices: l,
            value: m,
            storage: u,
            tensor: t
  ...
  fn i2o_${e1}(indices: ${h.indices}) -> u32 {
    return ${A.join("+")};
  }`, P = (W)=>(y.indicesToOffset = !0, a < 2 ? W : `i2o_${e1}(${W})`), D = (...W)=>a === 0 ? "0u" : `${h.indices}(${W.map(_).join(",")})`, R = (W, Y)=>a < 2 ? `${W}` : `${q(W, Y, a)}`, H = (W, Y, he)=>a < 2 ? `${W}=${he};` : `${q(W, Y, a)}=${he};`, L = {}, re = (W, Y)=>{
            y.broadcastedIndicesToOffset = !0;
            let he = `${Y.name}broadcastedIndicesTo${e1}Offset`;
            ...
            return L[he] = `fn ${he}(outputIndices: ${Y.type.indices}) -> u32 {
             return ${De.length > 0 ? De.join("+") : "0u"};
                ...
                if (h.storage === h.value) return `${e1}[${W}]=${Y};`;
                if (h.storage === "vec2<u32>" && h.value === "i32") return `${e1}[${W}]=vec2<u32>(u32(${Y}), select(0u, 0xFFFFFFFFu, ${Y} < 0));`;
                if (h.storage === "vec2<u32>" && h.value === "u32") return `${e1}[${W}]=vec2<u32>(u32(${Y}), 0u);`;
                if (h.storage === "u32" && h.value === "vec4<bool>") return `${e1}[${W}]=dot(vec4<u32>(0x1, 0x100, 0x10000, 0x1000000), vec4<u32>(${Y}));`;
  ...
  fn get_${e1}ByIndices(indices: ${h.indices}) -> ${m} {
    return ${K(`i2o_${e1}(indices)`)};
  }`, j = a < 2 ? "" : (()=>{
            let W = d.map((he)=>`d${he}: u32`).join(", "), Y = d.map((he)=>`d${he}`).join(", ");
            return `
  fn get_${e1}(${W}) -> ${m} {
    return get_${e1}ByIndices(${D(Y)});
  }`;
        })(), Q = (...W)=>{
            if (W.length !== a) throw new Error(`indices length must be ${a}`);
            let Y = W.map(_).join(",");
            return a === 0 ? K("0u") : a === 1 ? K(Y[0]) : (y.get = !0, y.getByIndices = !0, y.indicesToOffset = !0, `get_${e1}(${Y})`);
        }, ie = (W)=>a < 2 ? K(W) : (y.getByIndices = !0, y.indicesToOffset = !0, `get_${e1}ByIndices(${W})`), te = a < 2 ? "" : `
...
`);
            ...
            set: (...W)=>{
                ...
                return a === 0 ? V("0u", Y) : a === 1 ? V(he[0], Y) : (y.set = !0, y.setByIndices = !0, y.indicesToOffset = !0, `set_${e1}(${he}, ${Y})`);
            },
            setByOffset: V,
            setByIndices: (W, Y)=>a < 2 ? V(W, Y) : (y.setByIndices = !0, y.indicesToOffset = !0, `set_${e1}ByIndices(${W}, ${Y});`),
            get: Q,
            getByOffset: K,
            getByIndices: ie,
            usage: n,
    ...
    }, E = (e1, t, r, n = 1)=>Vr(e1, t, r, "input", n), M = (e1, t, r, n = 1)=>Vr(e1, t, r, "output", n), ts = (e1, t, r)=>Vr(e1, t, r, "atomicOutput", 1), Wr = (e1, t, r, n = 1)=>Vr(e1, t, r, "internal", n), io = class {
        constructor(t, r){
...
var dm, ns, lm, cm, pm, mm, Pe, os, is, dt = U(()=>{
    ...
    }, ns = (e1, t)=>t.length !== 0 ? t : [
            ...new Array(e1).keys()
        ].reverse(), lm = (e1, t)=>k.sortBasedOnPerm(e1, ns(e1.length, t)), cm = (e1, t, r, n)=>{
    ...
    var a: ${r.type.indices};`;
        ...
        let r = e1.dataType, n = e1.dims.length, o = ns(n, t), i = lm(e1.dims, o), a = e1.dims, d = i, l = n < 2 || mm(o, e1.dims), p;
        if (l) return p = (g)=>{
  ...
  ${g.mainStart()}
    ...
    output[global_idx] = input[global_idx];
        ...
        let { newShape: m, newPerm: u } = pm(e1.dims, o), h = k.areEqual(u, [
            2,
            3,
            1
        ]), _ = k.areEqual(u, [
...
var fm, hm, gm, bm, ym, _m, wm, vm, $m, xm, rt, as, ss, us, ds, ls, cs, ps, ms, fs, hs, gs = U(()=>{
    ...
    fm = {
       ...
       `, y = (g)=>`
        ...
        let o = e1.inputs.length === 1 ? r : uo(e1.inputs, r), i = o.axes;
        i.length === 0 && !o.noopWithEmptyAxes && (i = e1.inputs[0].dims.map((_, y)=>y));
        let a = k.normalizeAxes(i, e1.inputs[0].dims.length), d = a, l = e1.inputs[0], p = $m(d, e1.inputs[0].dims.length);
...
`)}
        ...
        let r = [];
        return e1[1].dims[0] > 0 && e1[1].getBigInt64Array().forEach((n)=>r.push(Number(n))), ee({
            axes: r,
            keepDims: t.keepDims,
            noopWithEmptyAxes: t.noopWithEmptyAxes
        });
    }, ot = (e1, t, r, n)=>{
        let o = e1.inputs, i = o.length === 1 ? r : uo(o, r);
        e1.compute(Gr(t, {
            hint: i.cacheKey,
            inputDependencies: [
                "rank"
...
`)}`,
        ...
        it(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Em(e1, t) : as(e1, t);
    }, ys = (e1, t)=>{
        it(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Im(e1, t) : ss(e1, t);
    }, _s = (e1, t)=>{
        it(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Cm(e1, t) : us(e1, t);
    }, ws = (e1, t)=>{
        it(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Am(e1, t) : ds(e1, t);
    }, vs = (e1, t)=>{
        it(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? km(e1, t) : ls(e1, t);
    }, $s = (e1, t)=>{
        it(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Pm(e1, t) : cs(e1, t);
    }, xs = (e1, t)=>{
        it(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? zm(e1, t) : ps(e1, t);
    }, Ss = (e1, t)=>{
        it(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Om(e1, t) : ms(e1, t);
    }, Ts = (e1, t)=>{
        it(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Dm(e1, t) : fs(e1, t);
    }, Is = (e1, t)=>{
        it(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Tm(e1, t) : hs(e1, t);
    };
});
...
var Bm, co, Mm, Rm, Um, Ut, Nm, Ps, Hr = U(()=>{
  ...
  ${$.mainStart([
    ...
    if (sum == 0) {
      ...
      ${a ? `
        ...
        let D = (R)=>{
            let H = E("q", t.dataType, t.dims, x), L = E("key", r.dataType, r.dims, x), re = [
                H,
                L
            ];
            if (A) {
            ...
            K && re.push(K);
            let we = M("output", t.dataType, m), j = [
                we
            ];
  ...
  ${C.mainStart([
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
    ...
    }, Ut = (e1, t, r, n, o, i, a, d, l, p, m = void 0, u = void 0)=>{
        let h = Math.min(e1.outputCount, 1 + (a ? 1 : 0) + (d ? 1 : 0)), _ = h > 1 ? p.pastSequenceLength : 0, y = _ + p.kvSequenceLength, g = l && k.size(l.dims) > 0 ? l : void 0, x = [
            t,
            r
        ];
        ...
        h > 1 && d && k.size(d.dims) > 0 && v.push(d), m && v.push(m), u && v.push(u), e1.compute(Um(h, $, n, d, p, _, m, u), {
            inputs: v,
            outputs: h > 1 ? [
                0,
                2
  ...
  ${u.mainStart([
    ...
    if (m < uniforms.M && n < uniforms.N) {
      ...
      output_v[outputIdx] = valueV;
        ...
        return Ut(e1, n, o, i, e1.inputs[4], void 0, void 0, void 0, e1.inputs[5], r);
    };
});
var Vm, Wm, Lm, zs, Os = U(()=>{
    ...
    Vm = (e1, t)=>{
        ...
        let { epsilon: r, spatial: n, format: o } = t, i = e1[0].dims, a = n ? me(i[i.length - 1]) : 1, d = o === "NHWC" && i.length > 1 ? a : 1, l = k.size(i) / a, p = n, m = p ? i.length : i, u = E("x", e1[0].dataType, e1[0].dims, a), h = E("scale", e1[1].dataType, e1[1].dims, d), _ = E("bias", e1[2].dataType, e1[2].dims, d), y = E("inputMean", e1[3].dataType, e1[3].dims, d), g = E("inputVar", e1[4].dataType, e1[4].dims, d), x = M("y", e1[0].dataType, m, a), $ = ()=>{
            let S = "";
  ...
  ${e1.mainStart()}
    ...
    ${m.setByOffset("global_idx", l)}
        ...
        return a && l.push(...a), {
            ...
            getShaderSource: (p)=>Fm(p, k.size(e1.dims), e1.dataType, i, r, n, d),
            getRunData: (p)=>({
                    outputs: [
                        {
                            dims: e1.dims,
                    ...
                    dispatchGroup: {
                        x: Math.ceil(k.size(p[0].dims) / 64 / 4)
                    },
                    programUniforms: l
                })
        };
...
fn erf_vf32(v: vec4<${e1}>) -> vec4<${e1}> {
  ...
  return sign(v) * (1.0 - ((((r5 * x + r4) * x + r3) * x + r2) * x + r1) * x * exp(-absv * absv));
        ...
        e1.compute(fe(e1.inputs[0], "Erf", (r)=>`erf_vf32(${r})`, Fr(t)));
    }, Qs = (e1)=>{
        ...
        let t = Ee(e1.inputs[0].dataType);
        e1.compute(fe(e1.inputs[0], "Gelu", (r)=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`, Fr(t)));
    }, eu = (e1, t)=>{
        let r = Ee(e1.inputs[0].dataType);
    ...
    }, pu = (e1)=>`sign(${e1}) * (1 - exp(-2 * abs(${e1}))) / (1 + exp(-2 * abs(${e1})))`, mu = (e1)=>{
        e1.compute(fe(e1.inputs[0], "Tanh", pu));
    }, po = (e1 = "f32")=>`
...
`, mo = (e1)=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e1} * (fast_gelu_c * ${e1} * ${e1} + fast_gelu_b))) * ${e1}`, fu = (e1)=>{
        let t = Ee(e1.inputs[0].dataType);
        e1.compute(fe(e1.inputs[0], "FastGelu", mo, po(t), void 0, e1.inputs[0].dataType));
    }, hu = (e1, t)=>{
        let r = Ee(e1.inputs[0].dataType);
...
`, jm = (e1)=>`quick_gelu_impl(${e1})`, bu = (e1, t)=>{
        let r = Ee(e1.inputs[0].dataType);
...
var Ym, Zm, _u, wu = U(()=>{
    ...
    Ym = (e1)=>{
        ...
        let r = E("input", e1[0].dataType, e1[0].dims, 4), n = E("bias", e1[0].dataType, [
            e1[0].dims[2]
        ], 4), o = M("output", e1[0].dataType, t, 4), i = k.size(t) / 4, a = ye(e1[0].dataType);
        return {
            name: "BiasSplitGelu",
            getRunData: ()=>({
                    outputs: [
...
var Qm, Xm, at, vu, $u, xu, Su, Tu, Iu, Cu, Au, ku, Eu, Pu = U(()=>{
    ...
    Qm = (e1, t, r, n, o, i, a, d, l, p, m, u)=>{
        ...
        let d = r.dims.map((g)=>Number(g) ?? 1), l = n.dims.map((g)=>Number(g) ?? 1), p = !k.areEqual(d, l), m = d, u = k.size(d), h = !1, _ = !1, y = [
            p
        ];
        if (p) {
...
`);
        ...
        let o = k.size(r), i = new Array(e1.length), a = new Array(e1.length), d = 0, l = [], p = [], m = [
            {
                type: 12,
                data: o
            }
...
var Xt, Yr, Zr = U(()=>{
    ...
    Xt = (e1, t, r, n, o)=>{
      ...
      if (${q(t.shape, d, t.rank)} != 1) {
        ${t.indicesSet(e1, d, q(o, d + i, n))}
      } else {
        ${t.indicesSet(e1, d, 0)}
      }`).join("")}
`;
    }, Yr = (e1, t, r, n, o = !1, i)=>{
        let a = e1[0].dims, d = e1[1].dims, l = a[a.length - 2], p = d[d.length - 1], m = a[a.length - 1], u = me(p), h = me(m), _ = me(l), y = k.size(r) / u / _, g = e1.length > 2, x = n ? n.slice(0, -2) : r.slice(0, -2), v = [
            k.size(x),
            l,
            p
        ], S = [
        ...
        je(t, S), S.push(...N(x, a, d)), g && S.push(...N(e1[2].dims)), S.push(...N(v));
        let T = (A)=>{
            let C = Wr("batch_dims", e1[0].dataType, x.length), P = E("a", e1[0].dataType, a.length, h), D = E("b", e1[1].dataType, d.length, u), R = M("output", e1[0].dataType, v.length, u), H = ye(R.type.tensor), L = Ke(t, R.type.value, H), re = [
                P,
                D
            ], V = "";
            if (g) {
                let j = o ? u : 1;
                re.push(E("bias", e1[2].dataType, e1[2].dims.length, j)), V = `${o ? `value += bias[col / ${j}];` : `value += ${R.type.value}(bias[row + i]);`}`;
            }
            let K = [
                {
                    name: "output_size",
...
var of, af, fo, Uu, sf, ho, uf, Jt, Qr = U(()=>{
    ...
    of = (e1, t)=>e1 ? `
        ...
        }`, fo = (e1, t, r = "f32", n, o = !1, i = 32, a = !1, d = 32)=>{
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `, sf = (e1)=>e1 ? "let ACached = mm_Asub[k][tileRow + innerRow];" : "let ACached = mm_Asub[tileRow + innerRow][k];", ho = (e1, t, r = "f32", n, o = !1, i = 32, a = !1, d = 32, l = !1)=>{
...
`;
    ...
    `;
        ...
        let a = e1[0].dims, d = e1[1].dims, l = a.slice(0, -2), p = d.slice(0, -2), m = n ? n.slice(0, -2) : r.slice(0, -2), u = k.size(m), h = a[a.length - 2], _ = a[a.length - 1], y = d[d.length - 1], g = _ % 4 === 0 && y % 4 === 0, x = h <= 8 ? [
            4,
            1,
            1
        ] : [
        ...
        L && (R.push(...N(e1[2].dims)), H.push("rank")), R.push(...N(D));
        let re = (V)=>{
            let K = m.length, we = Wr("batchDims", e1[0].dataType, K, 1), j = ye(e1[0].dataType), Q = E("a", e1[0].dataType, A, S), ie = E("b", e1[1].dataType, P, S), te = M("result", e1[0].dataType, D.length, S), be = [
                Q,
                ie
            ];
            if (L) {
                let Y = o ? S : 1;
                be.push(E("bias", e1[2].dataType, e1[2].dims.length, Y));
            }
            let Oe = [
                {
                    name: "dim_a_outer",
            ...
            Ye(t, Oe);
            let ve = ye(te.type.tensor), de = Ke(t, te.type.value, ve), W = uf(S, L, de, [
                we,
                Q,
                ie,
                te
...
var df, Nu, Vu = U(()=>{
    ...
    return ${Ae(d, p)}(0.0);`, A = Ae(l, p), C = e1 ? Ae(a, p) : Ae(d, p), P = e1 ? Ae(d, p) : Ae(a, p), D = Ke(i, A, p);
        return `
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${A}) {
      ...
      setOutputAtCoords(coords[0], coords[1], coords[2], coords[3], value);
        ...
        let A = g ? p && m % 4 !== 0 ? 3 : 4 : 1, C = v[1] * S[1], P = v[0] * S[0], D = Math.max(v[0] * A, v[1]), R = n % C === 0, H = o % P === 0, L = i % D === 0, re = g ? [
            A,
            4,
            4
        ] : [
        ...
        je(t, V), V.push(...N(e1[0].dims, e1[1].dims));
        let K = [
            "rank",
            "rank"
        ];
        a && (V.push(...N(e1[2].dims)), K.push("rank")), V.push(...N(r));
        let we = (j)=>{
            let Q = [
                {
                    name: "dim_a_outer",
            ...
            Ye(t, Q);
            let ie = g ? 4 : 1, te = ye(e1[0].dataType), be = `
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${g ? `vec4<${te}>` : te}) {
      ...
      }`, Oe = E("x", e1[0].dataType, e1[0].dims.length, A === 3 ? 1 : A), ve = E("w", e1[1].dataType, e1[1].dims.length, ie), de = [
                Oe,
                ve
            ], W = M("result", e1[0].dataType, r.length, ie);
            if (a) {
                let Y = E("bias", e1[2].dataType, e1[2].dims.length, ie);
                de.push(Y), be += `
        ...
        ${g ? fo(S, v, te, void 0, !p, D) : ho(S, v, te, void 0, !p, D, !1, void 0, d)}`;
        };
        return {
            name: "Conv2DMatMul",
            shaderCache: {
                hint: `${t.cacheKey};${A};${g};${R};${H};${L};${C};${P};${D}`,
                inputDependencies: K
            },
            getRunData: ()=>({
                    outputs: [
...
var lf, Wu, Xr, cf, Lu, pf, Gu, Hu, Fu = U(()=>{
    ...
    lf = (e1)=>{
        ...
        return t;
    }, Wu = (e1)=>typeof e1 == "number" ? [
            e1,
            e1,
            e1
        ] : e1, Xr = (e1, t)=>t <= 1 ? e1 : e1 + (e1 - 1) * (t - 1), cf = (e1, t, r, n = 1)=>{
        let o = Xr(t, n);
    ...
    }, Gu = (e1, t, r, n, o, i = !1, a = "channelsLast")=>{
        let d, l, p, m, u;
        if (a === "channelsLast") [d, l, p, m, u] = e1;
        else if (a === "channelsFirst") [d, u, l, p, m] = e1;
        else throw new Error(`Unknown dataFormat ${a}`);
        let [h, , _, y, g] = t, [x, $, v] = Wu(r), [S, T, A] = Wu(n), C = Xr(_, S), P = Xr(y, T), D = Xr(g, A), { padInfo: R, outDepth: H, outHeight: L, outWidth: re } = pf(o, l, p, m, x, $, v, C, P, D), V = i ? h * u : h, K = [
            0,
            0,
            0,
            0,
        ...
        let h = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : 1, _ = k.size(r), y = [
            {
                type: 12,
                data: _
            },
        ...
        je(t, y), y.push(...N(e1[0].dims, e1[1].dims));
        let g = [
            "rank",
            "rank"
        ], x = e1.length === 3;
        ...
        let $ = (v)=>{
            ...
            Ye(t, S);
            let T = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : 1, A = ye(e1[0].dataType), C = E("x", e1[0].dataType, e1[0].dims.length, ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : h), P = E("W", e1[1].dataType, e1[1].dims.length, T), D = [
                C,
                P
            ], R = M("result", e1[0].dataType, r.length, T), H = "";
            if (x) {
                let V = E("bias", e1[2].dataType, e1[2].dims.length, T);
                D.push(V), H += `
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : A} {
          return bias[${a ? q("coords", 4, 5) : q("coords", 1, 5)}${("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : ""}];
        }`;
            }
...
var qu, Ku, ju = U(()=>{
    ...
    yt();
    qu = (e1, t, r, n)=>{
        let o = e1.length > 2, i = o ? "value += b[output_channel];" : "", a = e1[0].dims, d = e1[1].dims, l = t.format === "NHWC", p = l ? r[3] : r[1], m = p / t.group, u = l && m >= 4 ? me(p) : 1, h = k.size(r) / u, _ = [
            {
                type: 12,
                data: h
            },
        ...
        let g = (x)=>{
            let $ = M("output", e1[0].dataType, r.length, u), v = ye($.type.tensor), S = Ke(t, $.type.value, v), T = E("x", e1[0].dataType, a.length), A = E("w", e1[1].dataType, d.length, u), C = [
                T,
                A
            ];
            o && C.push(E("b", e1[2].dataType, e1[2].dims, u));
            let P = [
                {
                    name: "output_size",
                    type: "u32"
  ...
  ${x.mainStart()}
    ...
    ${$.setByOffset("global_idx", "value")}
        ...
        let o = e1.length > 2, i = me(r[3]), a = me(r[2]), d = k.size(r) / i / a, l = [
            e1[0].dims[0],
            e1[0].dims[1],
            e1[0].dims[2],
            e1[0].dims[3] / i
        ...
        let h = (a - 1) * t.strides[1] + p[1], _ = (y)=>{
            let g = M("output", e1[0].dataType, m.length, i), x = ye(g.type.tensor), $ = Ke(t, g.type.value, x), v = E("x", e1[0].dataType, l.length, i), S = E("w", e1[1].dataType, p.length, i), T = [
                v,
                S
            ];
            o && T.push(E("b", e1[2].dataType, e1[2].dims, i));
            let A = o ? "value += b[output_channel];" : "", C = [
                {
                    name: "output_size",
                    type: "u32"
                },
...
var mf, go, ff, bo, yo, Yu, hf, gf, _o, Zu = U(()=>{
    ...
    mf = (e1, t, r, n, o, i)=>{
        ...
        let n = e1.pads.slice();
        kt.adjustPadsBasedOnAutoPad(t[0].dims, e1.strides, e1.dilations, r, n, e1.format === "NHWC", e1.autoPad);
        ...
        if (r.group !== 1) {
            ...
            if (o) {
                let D = e1.kernelCustomData.wT ?? e1.compute(Pe(t[1], go), {
                    inputs: [
                        1
                    ],
                    outputs: [
                ...
                r.wIsConst && !e1.kernelCustomData.wT && (e1.kernelCustomData.wT = D), C.push(D);
            } else C.push(t[1]);
            t.length === 3 && C.push(t[2]), !e1.adapterInfo.isArchitecture("ampere") && o && t[1].dims[0] === r.group && t[1].dims[1] === 1 && r.dilations[0] === 1 && r.dilations[1] === 1 ? e1.compute(Ku(C, r, i, n), {
                inputs: C
            }) : e1.compute(qu(C, r, i, n), {
                inputs: C
            });
            return;
        }
        ...
        if (g || m === 1 && u === 1 && r.dilations[0] === 1 && r.dilations[1] === 1 && r.strides[0] === 1 && r.strides[1] === 1 && r.pads[0] === 0 && r.pads[1] === 0) {
            let C = i[0], P, D, R, H = [];
            if (o) {
                let V = e1.kernelCustomData.wT ?? e1.compute(Pe(t[1], go), {
                    inputs: [
                        1
                    ],
                    outputs: [
            ...
            L < 8 && re < 8 ? e1.compute(Yr(H, r, i, R, o, n), {
                inputs: H
            }) : e1.compute(Jt(H, r, i, R, o, n), {
                inputs: H
            });
            return;
        }
        let x = !0, $ = e1.kernelCustomData.wT ?? e1.compute(Pe(t[1], go), {
            inputs: [
                1
            ],
            outputs: [
        ...
        e1.compute(Nu(v, r, i, S, T, A, a, x, n), {
            inputs: v
        });
    }, hf = (e1, t)=>{
        ...
        let n = r.format === "NHWC" ? "channelsLast" : "channelsFirst", o = bo(r, t), i = r.autoPad === "NOTSET" ? r.pads : r.autoPad, a = Gu(t[0].dims, t[1].dims, r.strides, r.dilations, i, !1, n);
        e1.compute(Hu(t, o, a.outShape, [
            a.filterDepth,
            a.filterHeight,
            a.filterWidth
        ], [
...
var Qu, Xu = U(()=>{
    ...
    ae();
    Qu = (e1, t, r)=>{
        let n = e1.length > 2, o = t.outputShape, i = t.format === "NHWC", a = t.group, d = e1[1].dims, l = d[2] / a, p = d[3], m = i ? me(l) : 1, u = i ? me(p) : 1, h = i ? p === 1 ? m : u : 1, _ = k.size(o) / u, y = [
            Math.ceil(_ / 64),
            1,
            1
        ];
        ...
        let C = (P)=>{
            ...
            ], R = ye(e1[0].dataType), H = i ? 1 : 2, L = i ? 2 : 3, re = i ? 3 : 1, V = E("W", e1[1].dataType, e1[1].dims.length, h), K = E("Dy", e1[0].dataType, e1[0].dims.length, m), we = [
                K,
                V
            ];
            n && we.push(E("bias", e1[2].dataType, [
                o[re]
            ].length, u));
            let j = M("result", e1[0].dataType, o.length, u), Q = ()=>{
                let te = "";
                if (m === 1) te += `
...
var $f, od, id, ad = U(()=>{
    ...
    ae();
    $f = (e1, t, r, n)=>{
        let o = k.size(t), i = t.length, a = E("input", e1, i), d = M("output", e1, i), l = r.dataType === 6 ? r.getInt32Array()[0] : Number(r.getBigInt64Array()[0]), p = k.normalizeAxis(l, i), m = (u)=>{
        ...
        return {
            ...
            getRunData: ($)=>{
                let v = l ? [
                    ...
                    n * p,
                    o * p
                ], S = k.size(v), T = u.dims, A = k.sortBasedOnPerm(T, d);
                return {
                    outputs: [
                        {
                            dims: v,
...
var wo, Jr, ld, If, Cf, vo, $o, cd, Af, pd, md, fd = U(()=>{
    ...
    }, cd = (e1)=>e1 + "_max", Af = (e1, t, r, n)=>{
        let i = e1.map((m)=>m.length).map((m, u)=>E(`input${u}`, t, m)), a = k.size(n), d = M("output", t, n.length), l = [
            ...r.symbolToInfo.keys()
            ...
            let T = S ? [
                ...u,
                `let sum = ${i.map((A, C)=>A.getByIndices(`input${C}Indices`)).join(" * ")};`
            ] : [
                ...u,
                _,
                ...x,
...
var kf, hd, Ef, Pf, gd, bd = U(()=>{
    ...
    kf = (e1)=>{
        ...
        return n;
    }, Ef = (e1, t)=>e1.length > t.length ? hd(e1, t) : hd(t, e1), Pf = (e1)=>{
        let t = e1[0].dims, r = Array.from(e1[1].getBigInt64Array(), Number), n = Ef(t, r), o = e1[0].dataType, i = o === 9 || k.size(t) === 1, a = o === 9 || t.length > 0 && t[t.length - 1] % 4 === 0 ? 4 : 1, d = i || n.length > 0 && n[n.length - 1] % 4 === 0 ? 4 : 1, l = Math.ceil(k.size(n) / d), p = (u)=>{
...
var zf, yd, _d = U(()=>{
    ...
    ${a.mainStart(Et)}
      ...
      ${p.setByOffset("global_idx", mo("x_in"))}
        ...
        e1.inputs.length < 2 || k.size(e1.inputs[1].dims) === 0 ? fu(e1) : e1.compute(zf(e1.inputs));
    };
});
var Of, Df, wd, vd, $d = U(()=>{
    "use strict";
    ...
    Of = (e1)=>{
        ...
        a.splice(i, 1, ...n);
        let d = r[i], l = e1[0].dataType === 9 ? 4 : 1, p = Math.ceil(k.size(a) / l), m = [
            {
                type: 12,
                data: p
            },
...
var Bf, xd, Sd, Td = U(()=>{
  ...
  ${h.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
        ...
        let r = e1.inputs, n = r[0].dims, o = r[0].dataType, i = r[1].dims, a = i[i.length - 1], d = k.sizeToDimension(i, i.length - 1), l = k.sizeFromDimension(n, t.batchDims + a), p = k.sizeToDimension(n, t.batchDims), m = k.sizeFromDimension(n, t.batchDims), u = d / p, h = new Array(a), _ = l;
        ...
        let x = i.slice(0, -1).concat(n.slice(g)), $ = k.size(x), v = [
            {
                type: 12,
                data: $
            },
...
var Mf, Rf, Id, Cd, Ad = U(()=>{
    ...
    Mf = (e1, t)=>{
        ...
        let r = e1[0].dims, n = e1[1].dims, o = r.length, i = k.normalizeAxis(t.gatherAxis, o), a = k.normalizeAxis(t.quantizeAxis, o), d = r.slice(0);
        d.splice(i, 1, ...n);
        let l = k.size(d), p = e1[2].dataType, u = e1[0].dataType === 22, h = [
            {
                type: 12,
                data: l
            },
...
var Uf, Nf, kd, Ed, Pd = U(()=>{
    ...
    Uf = (e1)=>{
        ...
        let r = e1[0].dims, n = e1[0].dataType, o = r.length, i = e1[1].dims, a = e1[1].dataType, d = k.normalizeAxis(t.axis, o), l = r[d], p = i.slice(0), m = k.size(p), u = E("input", n, o), h = E("indicesInput", a, i.length), _ = M("output", n, p.length), y = [
            {
                type: 12,
                data: m
            },
...
var Vf, Wf, zd, Od, Dd = U(()=>{
    ...
    Vf = (e1)=>{
        ...
        let r = e1[0].dims.slice(), n = e1[1].dims.slice(), [o, i, a] = Nr.getShapeOfGemmResult(r, t.transA, n, t.transB, e1.length === 3 ? e1[2].dims : void 0), d = [
            o,
            i
        ];
        ...
        let l = 16, p = Math.ceil(i / l), m = Math.ceil(o / l), u = !0, h = k.size(d), _ = [
            {
                type: 12,
                data: ("TURBOPACK compile-time truthy", 1) ? p : ("TURBOPACK unreachable", undefined)
            },
            {
                type: 12,
                data: o
        ...
        let g = ($)=>{
            ...
            let S = t.alpha === 1 ? "" : "value *= uniforms.alpha;", T = E("a", e1[0].dataType, e1[0].dims), A = E("b", e1[1].dataType, e1[1].dims), C = T.type.value, P = null, D = [
                T,
                A
            ];
  ...
  ${$.mainStart()}
    ...
    output[global_idx] = value;
            ...
            let C = M("output", e1[0].dataType, d.length);
            A.push(C);
            let P = [
                {
                    name: "num_tile_n",
...
`, jf = (e1, t, r)=>(()=>{
        ...
        let a = M("output", e1[0].dataType, i.length), d = r.type.value, l = k.size(i), p = [
            {
                type: 12,
                data: l
            },
...
var Me, Xf, Nd, Ud, Jf, er, Vd, xo = U(()=>{
    ...
    ae();
    dt();
    Me = (e1, t)=>e1.length > t && e1[t].dims.length > 0 ? e1[t] : void 0, Xf = (e1, t)=>{
        let r = e1[0], n = Me(e1, 1), o = Me(e1, 2), i = Me(e1, 3), a = Me(e1, 4), d = Me(e1, 5), l = Me(e1, 6), p = Me(e1, 7);
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
        ...
        if (a && k.size(a.dims) > 0) {
            ...
            return l = Jf(e1, i, a, t, n, r * o, d), l = l.reshape([
                ...
                r,
                o
            ]), r === 1 || n === 1 ? l : e1.compute(Pe(l, Ud.perm), {
                inputs: [
                    l
                ],
                outputs: [
        ...
        let r = Xf(e1.inputs, t), n = e1.inputs[0], o = Me(e1.inputs, 1), i = Me(e1.inputs, 2), a = Me(e1.inputs, 3), d = Me(e1.inputs, 4), l = Me(e1.inputs, 5), p = Me(e1.inputs, 6), m = Me(e1.inputs, 7);
        ...
        let u = o && i && o.dims.length === 4 && i.dims.length === 4, h = er(e1, r.batchSize, r.numHeads, r.sequenceLength, r.headSize, n, a, 0);
        if (u) return Ut(e1, h, o, i, d, void 0, p, m, l, r);
        if (!o || !i) throw new Error("key and value must be provided");
        let _ = er(e1, r.batchSize, r.numHeads, r.kvSequenceLength, r.headSize, o, a, r.hiddenSize), y = er(e1, r.batchSize, r.numHeads, r.kvSequenceLength, r.vHeadSize, i, a, 2 * r.hiddenSize);
        Ut(e1, h, _, y, d, void 0, p, m, l, r);
    };
});
var eh, th, rh, nh, So, Wd, Ld, To = U(()=>{
    ...
    eh = (e1)=>{
        ...
        return e1[1].dims[0] > 0 && (e1[1].getBigInt64Array().forEach((o)=>r.push(Number(o))), n = r.length), ee({
            numOutputs: n,
            axis: t.axis,
            splitSizes: r
        });
...
fn calculateOutputIndex(index: u32) -> u32 {
    ...
    if (index < ${q("uniforms.size_in_split_axis", "i", e1)}) {
        return i;
    }
    }
    return ${e1}u;
...
`)}
        ...
        let r = e1[0].dims, n = k.size(r), o = e1[0].dataType, i = k.normalizeAxis(t.axis, r.length), a = new Array(t.numOutputs), d = E("input", o, r.length), l = new Array(t.numOutputs), p = [], m = [], u = 0, h = [
            {
                type: 12,
                data: n
            }
...
var oh, ih, Gd, Hd, Fd = U(()=>{
    ...
    oh = (e1, t)=>{
        ...
        if (r.dims.length !== 3 && r.dims.length !== 5) throw new Error("Input query is expected to have 3 or 5 dimensions");
        let d = !1, l = r.dims[0], p = r.dims[1], m = r.dims.length === 3 ? ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : r.dims[2] : t.numHeads * r.dims[4], u = p, h = 0, _ = !n || n.dims.length === 0, y = Math.floor(_ ? m / (t.numHeads + 2 * t.kvNumHeads) : m / t.numHeads);
        _ && (m = y * t.numHeads);
        ...
        let n = e1.inputs[0], o = e1.inputs[1] && e1.inputs[1].dims.length > 0 ? e1.inputs[1] : void 0, i = e1.inputs[2] && e1.inputs[2].dims.length > 0 ? e1.inputs[2] : void 0, a = e1.inputs[3] && e1.inputs[3].dims.length !== 0 ? e1.inputs[3] : void 0, d = e1.inputs[4] && e1.inputs[4].dims.length !== 0 ? e1.inputs[4] : void 0, l = e1.inputs.length > 4 ? e1.inputs[5] : void 0, p = e1.inputs.length > 5 ? e1.inputs[6] : void 0, m = r.kvNumHeads ? r.kvNumHeads : r.numHeads, u = ee({
            axis: 2,
            numOutputs: 3,
            splitSizes: [
            ...
            o,
            i
        ], g = er(e1, r.batchSize, r.numHeads, r.sequenceLength, r.headSize, h, void 0, 0);
        Ut(e1, g, Gd(e1, _, r), Gd(e1, y, r), void 0, void 0, a, d, void 0, r, l, p);
    };
});
var qd, ah, sh, Kd, jd = U(()=>{
    ...
    qd = (e1, t, r, n, o, i, a, d)=>{
        ...
        x.push(...N(_, y));
        let $ = (v)=>{
            let S = E("x", t.dataType, 3, l), T = E("scale", r.dataType, r.dims), A = E("bias", n.dataType, n.dims), C = M("output", 1, 3, 2), P = [
                S,
                T,
                A,
                C
  ...
  ${v.mainStart(h)}
    ...
    if (local_idx == 0) {
      ...
      output[workgroup_index] = vec2f(channel_scale, channel_shift);
        ...
        let n = t[0].dims, o = n, i = 2, a = n[0], d = n[1], l = k.sizeFromDimension(n, i), p = me(l), m = k.size(o) / p, u = qd(e1, t[0], t[1], t[2], a, l, d, r.epsilon), h = [
            a,
            d,
            l / p
        ], _ = [
  ...
  ${x.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${S.setByOffset("global_idx", "value")};
        ...
        let n = t[0].dims, o = n, i = n[0], a = n[n.length - 1], d = k.sizeFromDimension(n, 1) / a, l = me(a), p = k.size(o) / l, m = [
            {
                type: 12,
                data: d
            },
        ...
        let y = h ? e1.compute(Pe(e1.inputs[0], _), {
            ...
            length: n.length
        }, ($, v)=>n[_[v]])), g = qd(e1, y, t[1], t[2], i, d, a, r.epsilon), x = ($)=>{
...
var uh, dh, Yd, Zd = U(()=>{
    ...
    uh = (e1)=>{
        ...
        let n = t.simplified, o = e1[0].dims, i = e1[1], a = !n && e1[2], d = o, l = k.normalizeAxis(t.axis, o.length), p = k.sizeToDimension(o, l), m = k.sizeFromDimension(o, l), u = k.size(i.dims), h = a ? k.size(a.dims) : 0;
...
var lh, Qd, Xd = U(()=>{
    ...
    lh = (e1)=>{
        ...
        if (r < 8 && n < 8) e1.compute(Yr(e1.inputs, {
            activation: ""
        }, t));
        else {
...
var ch, ph, mh, Jd, el, tl = U(()=>{
    ...
    ch = (e1, t)=>{
        ...
        let r = e1[0].dims, n = r.length, o = r[n - 2], i = t.k, a = t.n, d = r.slice(0, n - 2), l = k.size(d), m = e1[1].dims[2] / 4, u = e1[0].dataType, h = me(t.k), _ = me(m), y = me(a), g = d.concat([
            o,
            a
        ]), x = o > 1 && a / y % 2 === 0 ? 2 : 1, $ = k.size(g) / y / x, v = 64, S = [], T = [
            l,
            o,
            i / h
        ], A = k.convertShape(e1[1].dims).slice();
        A.splice(-1, 1, m / _), S.push(...N(T)), S.push(...N(A)), S.push(...N(e1[2].dims)), e1.length === 4 && S.push(...N(k.convertShape(e1[3].dims)));
        let C = [
            l,
            o,
            a / y
        ...
        S.push(...N(C));
        let P = (D)=>{
            let R = T.length, H = E("a", e1[0].dataType, R, h), L = E("b", 12, A.length, _), re = E("scales", e1[2].dataType, e1[2].dims.length), V = [
                H,
                L,
                re
            ], K = e1.length === 4 ? E("zero_points", 12, e1[3].dims.length) : void 0;
            K && V.push(K);
            let we = C.length, j = M("output", e1[0].dataType, we, y), Q = ye(e1[0].dataType), ie = (()=>{
                switch(h){
                    case 1:
                        return `array<${Q}, 8>`;
                    case 2:
          ...
          `;
            ...
            b_quantized_values = ${ie}(${Array.from({
                    length: 4
                }, (W, Y)=>`${Q}(b_value_lower[${Y}]), ${Q}(b_value_upper[${Y}])`).join(", ")});
            b_dequantized_values = ${(()=>h === 1 ? `${ie}(${Array.from({
                        length: 8
                    }, (W, Y)=>`(b_quantized_values[${Y}] - ${K ? `zero_point${de}` : "zero_point"}) * scale${de}`).join(", ")});` : `(b_quantized_values - ${ie}(${Array(8).fill(`${K ? `zero_point${de}` : "zero_point"}`).join(",")})) * scale${de};`)()};
            workgroup_shared[local_id.x * ${x} + ${Math.floor(de / y)}]${y > 1 ? `[${de % y}]` : ""} += ${Array.from({
                    length: 8 / h
                }, (W, Y)=>`${h === 1 ? `a_data[${Y}] * b_dequantized_values[${Y}]` : `dot(a_data[${Y}], b_dequantized_values[${Y}])`}`).join(" + ")};
          `;
                return ve;
            }, be = ()=>{
                let ve = `
        ...
        let r = e1[0].dims, n = r.length, o = r[n - 2], i = t.k, a = t.n, d = r.slice(0, n - 2), l = k.size(d), m = e1[1].dims[2] / 4, u = e1[0].dataType, h = me(t.k), _ = me(m), y = d.concat([
            o,
            a
        ]), g = 128, x = a % 8 === 0 ? 8 : a % 4 === 0 ? 4 : 1, $ = g / x, v = $ * _ * 8, S = v / h, T = v / t.blockSize, A = k.size(y) / x, C = [], P = [
            l,
            o,
            i / h
        ], D = k.convertShape(e1[1].dims).slice();
        D.splice(-1, 1, m / _), C.push(...N(P)), C.push(...N(D)), C.push(...N(e1[2].dims)), e1.length === 4 && C.push(...N(k.convertShape(e1[3].dims)));
        let R = [
            l,
            o,
            a
        ...
        C.push(...N(R));
        let H = (L)=>{
            let re = P.length, V = E("a", e1[0].dataType, re, h), K = E("b", 12, D.length, _), we = E("scales", e1[2].dataType, e1[2].dims.length), j = [
                V,
                K,
                we
            ], Q = e1.length === 4 ? E("zero_points", 12, e1[3].dims.length) : void 0;
            Q && j.push(Q);
            let ie = R.length, te = M("output", e1[0].dataType, ie), be = ye(e1[0].dataType), Oe = ()=>{
                switch(h){
                    case 1:
                        return `
          ...
          for (var tile: u32 = 0; tile < num_tiles; tile += 1) {
            ...
            for (var i: u32 = 0; i < ${_}; i++) {
              ...
              let b_quantized_values = mat2x4<${be}>(${Array.from({
                length: 4
            }, (ve, de)=>`${be}(b_value_lower[${de}]), ${be}(b_value_upper[${de}])`).join(", ")});
              ...
              inter_results[local_id.y][local_id.x] += ${Array.from({
                length: 2
            }, (ve, de)=>`${`dot(a_data${de}, b_dequantized_values[${de}])`}`).join(" + ")};
              word_offset += ${8 / h};
            }
            workgroupBarrier();
          }
...
var fh, hh, gh, bh, yh, _h, wh, vh, rl, nl = U(()=>{
    ...
    fh = (e1)=>{
        ...
        for(let o = t - 1; o >= 0; --o)n += `
            k = i32(${e1.indicesGet("indices", o)}) - ${q("uniforms.pads", o, r)};
            if (k < 0) {
              break;
            }
...
var en, ol, il, al, sl, $h, xh, ul, dl, ll, cl, pl, ml, fl, hl, gl, bl, yl, _l, wl = U(()=>{
    ...
    ae();
    en = (e1)=>{
        if (_e.webgpu.validateInputContent && (!e1 || e1.length !== 1)) throw new Error("Pool ops requires 1 input.");
    }, ol = (e1, t, r)=>{
    ...
    }, sl = (e1)=>`${e1.format};${e1.ceilMode};${e1.autoPad};${e1.kernelShape.length}`, $h = (e1)=>`${sl(e1)};${e1.countIncludePad}`, xh = (e1)=>`${sl(e1)};${e1.storageOrder};${e1.dilations}`, ul = (e1)=>({
            format: e1.format,
            autoPad: [
                "NOTSET",
                "VALID",
        ...
        return {
            ...
            getShaderSource: (x)=>al(x, a, t.dims.length, i.length, o, l, p, 0, u, h, _, y)
        };
    }, ll = (e1)=>{
        ...
        en(e1.inputs), e1.compute(dl("AveragePool", e1.inputs[0], !1, t));
    }, pl = {
        autoPad: "",
        ceilMode: 0,
        countIncludePad: !1,
        ...
        en(e1.inputs), e1.compute(dl("GlobalAveragePool", e1.inputs[0], !0, t));
    }, hl = (e1, t, r, n)=>{
        let [o, i] = ol(t, n, r), a = `
    ...
    `, d = "", l = E("x", t.dataType, t.dims.length), p = [
        ...
        return m.push(...N(t.dims, i)), {
            ...
            getShaderSource: (g)=>al(g, l, t.dims.length, i.length, o, a, d, t.dataType === 10 ? -65504 : -1e5, u, h, _, y)
        };
    }, gl = (e1, t)=>{
        en(e1.inputs), e1.compute(hl("MaxPool", e1.inputs[0], !1, t));
    }, bl = (e1)=>{
        ...
        en(e1.inputs), e1.compute(hl("GlobalMaxPool", e1.inputs[0], !0, t));
    };
});
var Th, Ih, vl, $l, xl = U(()=>{
    "use strict";
    ...
    Th = (e1, t)=>{
        ...
        let r = k.normalizeAxis(t.axis, e1[0].dims.length), n = e1[0].dataType, o = n === 3, i = e1[0].dims, a = e1[1].dataType, d = k.size(i), l = n === 3 || n === 2, p = l ? [
            Math.ceil(k.size(e1[0].dims) / 4)
        ] : e1[0].dims, m = e1[1].dims, u = e1.length > 2 ? e1[2] : void 0, h = u ? l ? [
            Math.ceil(k.size(u.dims) / 4)
        ] : u.dims : void 0, _ = m.length === 0 || m.length === 1 && m[0] === 1, y = _ === !1 && m.length === 1, g = me(d), x = _ && (!l || g === 4), $ = x ? g : 1, v = x && !l ? g : 1, S = E("input", l ? 12 : n, p.length, v), T = E("scale", a, m.length), A = u ? E("zero_point", l ? 12 : n, h.length) : void 0, C = M("output", a, i.length, $), P = [
            S,
            T
        ];
        A && P.push(A);
...
var Ch, Ah, Sl, Tl = U(()=>{
    ...
    Ch = (e1, t, r)=>{
        ...
        let t = 0, r = 0, n = 0;
        e1.inputs[0].dataType === 6 ? (t = e1.inputs[0].getInt32Array()[0], r = e1.inputs[1].getInt32Array()[0], n = e1.inputs[2].getInt32Array()[0]) : e1.inputs[0].dataType === 1 && (t = e1.inputs[0].getFloat32Array()[0], r = e1.inputs[1].getFloat32Array()[0], n = e1.inputs[2].getFloat32Array()[0]), _e.webgpu.validateInputContent && Ch(t, r, n), e1.compute(Ah(t, r, n, e1.inputs[0].dataType), {
            inputs: []
        });
    };
});
var kh, Eh, Il, Cl, Al = U(()=>{
    ...
    kh = (e1, t, r, n)=>{
        ...
        let r = e1[0].dims, n = e1[1].dims, o = r, i = 1, a = Math.ceil(k.size(n) / i), d = n[n.length - 1], l = k.sizeFromDimension(r, d), p = [
            {
                type: 12,
                data: a
            },
            ...
            let h = E("indices", e1[1].dataType, e1[1].dims.length), _ = E("updates", e1[2].dataType, e1[2].dims.length, i), y = t.reduction !== "none" && t.reduction !== "" ? ts("output", e1[0].dataType, o.length) : M("output", e1[0].dataType, o.length, i);
            return `
    ...
    fn bilinearInterpolation(output_indices: ${t.type.indices}) -> ${m} {
      ...
      return (x11 * dx2 * dy2 + x12 * dx2 * dy1 + x21 * dx1 * dy2 + x22 * dx1 * dy1);
        ...
        let m = r.length === 2, u = !0, [h, _] = m ? [
            ...
            2,
            3
        ] : ("TURBOPACK unreachable", undefined), y = e1.type.value, g = (x)=>{
            let $ = x === h ? "row" : "col";
            return `
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${y} {
    ...
    depth = max(0, min(depth, ${r[d]} - 1));
      ...
      return (x111 * dx2 * dy2 * dz2 + x112 * dx2 * dy2 * dz1 + x121 * dx2 * dy1 *dz2 + x122 * dx2 * dy1 * dz1 +
        ...
        let m = M("output", e1.dataType, l.length), u = E("input", e1.dataType, a.length), h = k.size(l), _ = a.length === l.length && a.every((v, S)=>v === l[S]), y = t.coordinateTransformMode === "tf_crop_and_resize", g = t.extrapolationValue, x = u.type.value, $ = (v)=>`
      ${_ ? "" : `
...
`}
        ...
        return {
            name: "Resize",
            shaderCache: {
                hint: `${t.cacheKey}|${r}|${p.length > 0 ? t.mode === "cubic" ? p : p.length : ""}|${o.length > 0 ? o : ""}|${d.length > 0 ? d : ""}|${_}|${t.mode === "nearest" ? a.length : a}`,
                inputDependencies: [
                    "rank"
                ]
            },
...
var Kh, jh, Dl, Bl = U(()=>{
    ...
    Kh = (e1, t)=>{
        ...
        let { interleaved: r, numHeads: n, rotaryEmbeddingDim: o, scale: i } = t, a = e1[0].dims[0], d = k.sizeFromDimension(e1[0].dims, 1), l = e1[0].dims[e1[0].dims.length - 2], p = d / l, m = e1[2].dims[1], u = o === 0 ? m * 2 : p / n, h = new Array(a, l, p / u, u - m), _ = k.computeStrides(h), y = [
            {
                type: 1,
                data: i
            },
...
var Yh, Zh, Ml, Rl = U(()=>{
    ...
    Yh = (e1)=>{
        ...
        let o = t.simplified, i = e1[0].dims, a = k.size(i), d = i, l = a, p = i.slice(-1)[0], m = n ? i.slice(0, -1).concat(1) : [], u = !o && e1.length > 3, h = e1.length > 4, _ = n && r > 1, y = n && r > 2, g = r > 3, x = 64, $ = me(p), v = [
            {
                type: 12,
                data: l
            },
      ...
      ${A.mainStart([
        ...
        return r > 1 && T.push({
            ...
            shaderCache: {
                hint: `${$};${_};${y};${g}`,
                inputDependencies: e1.map((A, C)=>"type")
            },
            getShaderSource: S,
            getRunData: ()=>({
                    outputs: T,
...
var Qh, tn, Xh, Ul, Jh, eg, Nl, Vl, Wl = U(()=>{
    ...
    Qh = (e1, t)=>{
        ...
        if (e1.length > 1) {
            let r = tn(e1, 1), n = tn(e1, 2), o = tn(e1, 3);
            return o.length === 0 && (o = [
        ...
        let m = {
            dims: p,
            dataType: e1[0].dataType
        }, u = M("output", e1[0].dataType, p.length), h = E("input", e1[0].dataType, e1[0].dims.length), _ = k.size(p), y = [
            {
                name: "outputSize",
                type: "u32"
            },
...
var tg, rg, Ll, Gl, Hl = U(()=>{
    ...
    tg = (e1)=>{
        ...
        let r = e1.inputs[0], n = r.dims, o = k.size(n), i = n.length, a = k.normalizeAxis(t.axis, i), d = a < n.length - 1, l, p = [];
        d ? (p = Array.from({
            length: i
...
var Fl, ng, og, ig, ql, Kl = U(()=>{
    ...
    Fl = (e1)=>Array.from(e1.getBigInt64Array(), Number), ng = (e1)=>{
        ...
        let r = e1[0].dims, n = t ?? Fl(e1[1]), o = og(r, n), i = k.size(o), a = e1[0].dataType, d = E("input", a, r.length), l = M("output", a, o.length), p = (m)=>`
...
var ag, sg, jl, Yl = U(()=>{
    ...
    ag = (e1, t, r, n, o)=>{
        ...
        let t = e1[1].dims, r = e1[2].dims, n = e1[0].dims, o = e1[1].dataType, i = !(k.areEqual(t, r) && k.areEqual(r, n)), a = t, d = k.size(t);
        if (i) {
...
var ug, dg, Io, Co, nn, Jl = U(()=>{
    ...
    ug = (e1, t)=>{
        ...
        async initialize(t, r) {
            ...
            i("chromium-experimental-timestamp-query-inside-passes") || i("timestamp-query"), i("shader-f16"), i("subgroups") && i("subgroups-f16"), this.device = await r.requestDevice(o), this.deviceInfo = new Co(this.device), this.adapterInfo = new Io(r.info || await r.requestAdapterInfo()), this.gpuDataManager = Qa(this), this.programManager = new rn(this), this.kernels = new Map, this.kernelPersistentData = new Map, this.kernelCustomData = new Map, Mr(t.logLevel, !!t.debug), this.device.onuncapturederror = (a)=>{
        ...
        run(t, r, n, o, i, a) {
            ...
            if (m) {
                ...
                m.forEach((D, R)=>{
                    let H = T[R], L = typeof D.data == "number" ? [
                        D.data
                    ] : D.data;
                ...
                this.device.queue.writeBuffer(P.buffer, 0, C, 0, S), this.gpuDataManager.release(P.id), y = {
                    offset: 0,
                    size: S,
                    buffer: P.buffer
                };
...
var fg, Sr, Tr, zt, hg, qt, Ir, Cr, uc, Ar, kr, Er, Fn = U(()=>{
    ...
    Qn();
    fg = (e1, t)=>{
        Te()._OrtInit(e1, t) !== 0 && ce("Can't initialize onnxruntime.");
    }, Sr = async (e1)=>{
        fg(e1.wasm.numThreads, Yt(e1.logLevel));
    }, Tr = async (e1, t)=>{
        {
            let r = (sc(), gr(ac)).init;
            if (t === "webgpu") {
        ...
        try {
            let n = t.PTR_SIZE, o = t.stackAlloc(2 * n);
            t._OrtGetInputOutputCount(e1, o, o + n) !== 0 && ce("Can't get session input/output count.");
            let a = n === 4 ? "i32" : "i64";
            return [
        ...
        let t = Te(), r = t._malloc(e1.byteLength);
        ...
        try {
            ...
            for (let v of t?.executionProviders ?? [])if ((typeof v == "string" ? v : v.name) === "webnn") {
                if (o.shouldTransferToMLTensor = !1, typeof v != "string") {
                    ...
                    A ? o.currentContext = A : C ? o.currentContext = await o.jsepCreateMLContext(C) : o.currentContext = await o.jsepCreateMLContext({
                        deviceType: P,
                        powerPreference: D
                    });
            ...
            i = await o._OrtCreateSession(r, n, a), i === 0 && ce("Can't create a session."), o.jsepOnCreateSession?.(), o.currentContext && (o.jsepRegisterMLContext(i, o.currentContext), o.currentContext = void 0, o.shouldTransferToMLTensor = !0);
            ...
            let $ = null;
            return x.some((v)=>v === "gpu-buffer" || v === "ml-tensor") && (d = o._OrtCreateBinding(i), d === 0 && ce("Can't create IO binding."), $ = {
                handle: d,
                outputPreferredLocations: x,
                outputPreferredLocationsEncoded: x.map((v)=>Zn(v))
            }), zt.set(i, [
                i,
                p,
                m,
        ...
        let t = Te(), r = zt.get(e1);
        if (!r) throw new Error(`cannot release session. invalid session id: ${e1}`);
        let [n, o, i, a, d] = r;
        a && (d && t._OrtClearBoundOutputs(a.handle) !== 0 && ce("Can't clear bound outputs."), t._OrtReleaseBinding(a.handle) !== 0 && ce("Can't release IO binding.")), t.jsepOnReleaseSession?.(e1), o.forEach((l)=>t._OrtFree(l)), i.forEach((l)=>t._OrtFree(l)), t._OrtReleaseSession(n) !== 0 && ce("Can't release session."), zt.delete(e1);
    }, uc = (e1, t, r, n, o, i = !1)=>{
        if (!e1) {
            t.push(0);
            return;
        }
        let a = Te(), d = a.PTR_SIZE, l = e1[0], p = e1[1], m = e1[3], u, h;
    ...
    }, Ar = async (e1, t, r, n, o, i)=>{
        let a = Te(), d = a.PTR_SIZE, l = zt.get(e1);
        ...
        try {
            ...
            if (h && !y) {
                ...
                for(let j = 0; j < g; j++){
                    let Q = t[j];
                    await a._OrtBindInput(V, m[Q], S[j]) !== 0 && ce(`Can't bind input[${j}] for session=${e1}.`);
                }
                for(let j = 0; j < x; j++){
                    let Q = n[j];
                    o[j]?.[3] ? a._OrtBindOutput(V, u[Q], T[j], 0) !== 0 && ce(`Can't bind pre-allocated output[${j}] for session=${e1}.`) : a._OrtBindOutput(V, u[Q], 0, we[Q]) !== 0 && ce(`Can't bind output[${j}] to ${K[j]} for session=${e1}.`);
                }
                zt.set(e1, [
                    p,
                    m,
            ...
            for(let V = 0; V < x; V++){
                ...
                let we = a.stackSave(), j = a.stackAlloc(4 * d), Q = !1, ie, te = 0;
                try {
                    ...
                    if (ie === "string") {
                        ...
                        Q = !0, re.push([
                            ...
                            {
                                gpuBuffer: Ie,
                                download: a.jsepCreateDownloader(Ie, He, ie),
                                dispose: ()=>{
                        ...
                        let He = await pe(te, ve, Y, !1);
                        Q = !0, re.push([
                            ie,
                            Y,
                            {
                                mlTensor: He,
                                download: a.jsepCreateMLTensorDownloader(te, ie),
                                dispose: ()=>{
                        ...
                        new Uint8Array(Ie.buffer, Ie.byteOffset, Ie.byteLength).set(a.HEAPU8.subarray(te, te + Ie.byteLength)), re.push([
                            ie,
                            Y,
                            Ie,
                            "cpu"
            ...
            return h && !_ && (a._OrtClearBoundOutputs(h.handle) !== 0 && ce("Can't clear bound outputs."), zt.set(e1, [
                p,
                m,
                u,
                h,
...
var Ot, Ge, rr, dn, ln, un, Eo, Po, Wt, Lt, bg, dc, lc, cc, pc, mc, fc, hc, zo = U(()=>{
    ...
    gt();
    $r();
    Ot = ()=>!!_e.wasm.proxy && typeof document < "u", rr = !1, dn = !1, ln = !1, Po = new Map, Wt = (e1, t)=>{
        let r = Po.get(e1);
        r ? r.push(t) : Po.set(e1, [
            t
        ]);
    }, Lt = ()=>{
        ...
        switch(e1.data.type){
            case "init-wasm":
                rr = !1, e1.data.err ? (ln = !0, Eo[1](e1.data.err)) : (dn = !0, Eo[0]()), un && (URL.revokeObjectURL(un), un = void 0);
                break;
            case "init-ep":
            case "copy-from":
            case "create":
        ...
        if (!dn) {
            ...
            if (rr = !0, Ot()) return new Promise((e1, t)=>{
                Ge?.terminate(), Na().then(([r, n])=>{
                    try {
                        Ge = n, Ge.onerror = (i)=>t(i), Ge.onmessage = bg, Eo = [
                            e1,
                            t
                        ];
                        let o = {
                        ...
                        !o.in.wasm.wasmPaths && (r || __TURBOPACK__import$2e$meta__.url?.startsWith("file:")) && (o.in.wasm.wasmPaths = {
                            wasm: new __turbopack_context__.U(__turbopack_context__.r("[project]/node_modules/.pnpm/onnxruntime-web@1.21.0-dev.20250206-d981b153d3/node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.jsep.wasm (static in ecmascript)")).href
                        }), Ge.postMessage(o), un = r;
                    } catch (o) {
                        t(o);
                    }
                }, t);
            ...
            try {
                await xr(_e.wasm), await Sr(_e), dn = !0;
            } catch (e1) {
                throw ln = !0, e1;
            } finally{
                rr = !1;
        ...
        await Tr(_e, e1);
    }, cc = async (e1)=>Ot() ? (Lt(), new Promise((t, r)=>{
            Wt("copy-from", [
                t,
                r
            ]);
        ...
        if (Ot()) {
            ...
            return Lt(), new Promise((r, n)=>{
                ...
                e1 instanceof Uint8Array && i.push(e1.buffer), Ge.postMessage(o, i);
            });
        } else return Ir(e1, t);
    }, mc = async (e1)=>{
        if (Ot()) return Lt(), new Promise((t, r)=>{
...
var gc, yg, cn, bc = U(()=>{
    ...
    gc = (e1, t)=>{
        ...
        async loadModel(t, r) {
            Ne();
            let n;
            typeof t == "string" ? ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : n = await this.fetchModelAndCopyToWasmMemory(t) : n = t, [this.sessionId, this.inputNames, this.outputNames] = await pc(n, r), Be();
        }
        async dispose() {
...
var _c = {};
Ht(_c, {
    OnnxruntimeWebAssemblyBackend: ()=>pn,
    initializeFlags: ()=>yc,
    wasmBackend: ()=>_g
});
var yc, pn, _g, wc = U(()=>{
    ...
    yc = ()=>{
        if ((typeof _e.wasm.initTimeout != "number" || _e.wasm.initTimeout < 0) && (_e.wasm.initTimeout = 0), _e.wasm.simd === !1 && console.warn('Deprecated property "env.wasm.simd" is set to false. non-SIMD build is no longer provided, and this setting will be ignored.'), typeof _e.wasm.proxy != "boolean" && (_e.wasm.proxy = !1), typeof _e.wasm.trace != "boolean" && (_e.wasm.trace = !1), typeof _e.wasm.numThreads != "number" || !Number.isInteger(_e.wasm.numThreads) || _e.wasm.numThreads <= 0) if (typeof self < "u" && !self.crossOriginIsolated) _e.wasm.numThreads = 1;
            ...
            let e1 = typeof navigator > "u" ? Un("node:os").cpus().length : navigator.hardwareConcurrency;
            _e.wasm.numThreads = Math.min(4, Math.ceil((e1 || 1) / 2));
        }
    }, pn = class {
        async init(t) {
...
var $1 = Hn;
{
    let e1 = (wc(), gr(_c)).wasmBackend;
    Tt("webgpu", e1, 5), Tt("webnn", e1, 5), Tt("cpu", e1, 10), Tt("wasm", e1, 10);
...
//# sourceMappingURL=287ab_onnxruntime-web_dist_9e2edbbc._.js.map